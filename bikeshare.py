...
def get_filters():
    ...
    while True:
      month = input("\nYou can only filter by January, February, March, April, May, June or 'all', if you are not sure?\n").title()
    ...
    while True:
      day = input("\nYou can sort by days: Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday or type: 'all' if you are not sure.\n").title()
